        ...
        >
            <div className="w-full">
                <div className="text-center mb-12">
                    ...
                    >
                        <ContactBadge icon={MapPin} text={CONTACT_INFO.location}
                                      href={`https://www.google.com/maps/search/?api=1&query=${CONTACT_INFO.location}`}/>
                        <ContactBadge
                            icon={Mail}
                    ...
                    <motion.div variants={itemVariants}
                        ...
                        <motion.a
                            ...
                            className={`px-8 py-3 bg-gradient-to-r ${colors.download} text-white rounded-full font-semibold flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-shadow`}
                ...
                <motion.div variants={slideInFromRight}>
                    <div className={` ${colors.summaryBg} rounded-2xl shadow-xl p-6 md:p-8 border`}>
                        ...
                        <p className={`${isLight ? 'text-gray-700' : 'text-gray-300'} leading-relaxed text-base md:text-lg`}>
                            ...
                            components, implementing native functionality, and optimizing app performance for both
                            Android and iOS platforms. Excellent problem-solving and communication skills with a proven
                            ability to collaborate effectively in agile development teams. Eager to learn and apply the
                            latest industry trends and best practices. Committed to delivering high-quality code and
